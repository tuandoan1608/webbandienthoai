...
@section('content')
    <div class="content-wrapper">
        ...
        <form accept-charset="utf-8" action="/admin/roles/{{ $role->id }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <!-- Main content -->
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <div class=" row">
                                                    ...
                                                    <label for="disabledTextInput">Tên hiển thị
                                                        <span style="color: red;font-size:20px">*</span></label>
                                                        <input type="text" name="displayname" class="form-control" value="{{ $role->display_name }}" placeholder=""
                                                        required>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                @foreach ($item->permissionchildrent as $items)
                                                                    <div class="col-md-3">
                                                                        <input name="permission_id[]" {{ $permissionid->contains('permission_id',$items->id)?'checked':'' }} value="{{ $items->id }}" type="checkbox">
